...
[![Deploy Now](https://edas-hz.oss-cn-hangzhou.aliyuncs.com/edas-apps/charts-store/EDASpoc.png)](https://edasnext.console.aliyun.com/#/home?tab=marketplace&marketDetail=cordys-crm)
...
<p align="center">
  <a href="https://github.com/1Panel-dev/CordysCRM/releases"><img src="https://edas-hz.oss-cn-hangzhou.aliyuncs.com/edas-apps/charts-store/cordys-crm/image/CordysCRM.svg" alt="Latest release"></a>
  <a href="https://github.com/1Panel-dev/CordysCRM"><img src="https://edas-hz.oss-cn-hangzhou.aliyuncs.com/edas-apps/charts-store/cordys-crm/image/CordysCRM.svg" alt="Stars"></a>    
  <a href="https://hub.docker.com/r/1panel/cordys-crm"><img src="https://edas-hz.oss-cn-hangzhou.aliyuncs.com/edas-apps/charts-store/cordys-crm/image/cordys-crm.svg" alt="Download"></a><br/>
</p>
...
[![Watch the video](https://edas-hz.oss-cn-hangzhou.aliyuncs.com/edas-apps/charts-store/cordys-crm/image/overview-20251103.png)](https://www.bilibili.com/video/BV1gVh9zAEde/)
...
<table style="border-collapse: collapse; border: 1px solid black;">
  <tr>
    <td style="padding: 5px;background-color:#fff;"><img src= "https://edas-hz.oss-cn-hangzhou.aliyuncs.com/edas-apps/charts-store/cordys-crm/image/setting.png" alt="Settings" /></td>
    <td style="padding: 5px;background-color:#fff;"><img src= "https://edas-hz.oss-cn-hangzhou.aliyuncs.com/edas-apps/charts-store/cordys-crm/image/rbac.png" alt="RBAC" /></td>
  </tr>
  <tr>
    <td style="padding: 5px;background-color:#fff;"><img src= "https://edas-hz.oss-cn-hangzhou.aliyuncs.com/edas-apps/charts-store/cordys-crm/image/opportunity.png" alt="Opportunity List" /></td>
    <td style="padding: 5px;background-color:#fff;"><img src= "https://edas-hz.oss-cn-hangzhou.aliyuncs.com/edas-apps/charts-store/cordys-crm/image/opportunity-detail.png" alt="Opportunity Detail" /></td>
  </tr>
  <tr>
    <td style="padding: 5px;background-color:#fff;"><img src= "https://edas-hz.oss-cn-hangzhou.aliyuncs.com/edas-apps/charts-store/cordys-crm/image/bi.png" alt="BI" /></td>
    <td style="padding: 5px;background-color:#fff;"><img src= "https://edas-hz.oss-cn-hangzhou.aliyuncs.com/edas-apps/charts-store/cordys-crm/image/ai.png" alt="AI" /></td>
  </tr>  
</table>
